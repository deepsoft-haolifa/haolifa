...
update inspect_item ii,(select b.id,b.inspect_no,a.qualified_number,a.unqualified_number,a.material_graph_no from inspect_history a left join inspect b on a.inspect_no=b.inspect_no where a.type=1) hh set ii.inspect_no=hh.inspect_no,ii.unqualified_number=hh.unqualified_number,ii.qualified_number=hh.qualified_number where ii.inspect_id=hh.id and ii.material_graph_no=hh.material_graph_no;
