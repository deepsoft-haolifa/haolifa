...
public class SprayController {
    ...
    @ApiOperation("获取历史喷涂质检记录详情")
    @GetMapping("/inspect/history-info/{historyId}")
    public ResultBean getHistoryInfo(@PathVariable("historyId") Integer historyId) {
        return ResultBean.success(sprayService.getHistoryInfo(historyId));
    }
