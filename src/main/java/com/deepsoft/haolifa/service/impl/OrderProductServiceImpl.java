        ...
        try {
            ...
            while (entryIterator.hasNext()) {
                ...
                if (type.equals(CommonEnum.ProductModelType.FATI.code)) {
                    ...
                    log.info(
                            "checkMaterial fati check info,orderNo:{},needMaterialCount:{},graphNo:{},graphNoJ:{},quantityJ:{},quantity:{}",
                    ...
                    if (currentQuantityWithJ < materialCount) {
                        ...
                        currentQuantity = currentQuantityWithJ;
                        log.info(
                                "checkMaterial fati check info ,orderNo:{},graphNo:{},graphNoJ:{},quantityJ:{},jijiagong:{},quantity:{}",
                        ...
                        if (currentQuantityWithJ < materialCount) {
                            ...
                            log.info(
                                    "checkMaterial fati check info ,orderNo:{},graphNo:{},graphNoJ:{},quantityJ:{},quantityM:{},quantity:{}",
                    ...
                    if (currentQuantity < materialCount) {
                        ...
                        if (currentQuantity < materialCount) {
                            ...
                            log.info(
                                    "checkMaterial faban check info ,orderNo:{},graphNo:{},graphNoJ:{},quantityJ:{},jijiagong:{},quantity:{}",
                                    orderNo, graphNo, graphNoWithJ, currentQuantityWithJ, jingCount, currentQuantity);
                            // 如果库存中机加工和正在机加工的数量还小于要求的数量，查询库存中带M的库存
                            if (currentQuantity < materialCount) {
                                materialInfoWithM = materialService.getInfoByGraphNo(graphNoWithM);
                                ...
                                currentQuantity += currentQuantityWithM;
                                log.info(
                                        "checkMaterial faban check info ,orderNo:{},graphNo:{},graphNoJ:{},quantityJ:{},quantityM:{},quantity:{}",
                                        orderNo, graphNo, graphNoWithJ, currentQuantityWithJ, currentQuantityWithM, currentQuantity);
                                if (currentQuantity < materialCount) {
                                    lackMaterialCount = materialCount - currentQuantity;
                                } else {
