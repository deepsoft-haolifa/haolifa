...
public class EntryOutStoreRecordServiceImpl extends BaseService implements EntryOutStoreRecordService {
    ...
    public int outMaterial(OutMaterialStorageDTO model) {
        ...
        if (insert > 0) {
            ...
            log.info("material reduce stock result:{},materialNo:{},batchNo:{},rackNo:{},quantity:{}", reduceStock, materialGraphNo, materialBatchNo, rackNo, quantity);
            ...
            if (lockQuantity == 0) {
                ...
                if (lockQuantity >= Math.abs(quantity)) {
                    ...
                    log.info("this not appear material reduce lock quantity:{},needCurrentQuantity:{},graphNo:{}", lockQuantity, needCurrentQuantity, materialGraphNo);
