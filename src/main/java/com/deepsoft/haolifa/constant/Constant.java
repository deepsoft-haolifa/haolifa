...
public class Constant {
     ...
     * 成品质量检验失败列表
     */
    public static final String INSPECT_UNQUALIFIED_REASON = "扭距超,标牌歪或铆钉松动,标牌内容错误,磕碰补漆,砂眼,冷隔,调试不到位,出轴或轴方错误,上法兰孔距错误,侧法兰孔距错误,侧法兰断裂,阀座啃坏,阀座裂口,阀座材质错误,阀座端径安装不到位,阀体材质错误,手柄与齿盘安装不到位,手柄断裂,手柄晃动,出轴晃动,打磨不到位,铸字不清,订单错误,技术清单错误,外观不良,阀门关闭后阀板与阀座有缝隙";
    /**
     * 压力质检不合格失败列表
     */
