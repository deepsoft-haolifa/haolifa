...
public class Spray {
    ...
    public Spray(Integer id, String sprayNo, String planner, Integer totalNumber, Integer qualifiedNumber, Byte status, String fileUrl, Date createTime, Date updateTime) {
        this.id = id;
