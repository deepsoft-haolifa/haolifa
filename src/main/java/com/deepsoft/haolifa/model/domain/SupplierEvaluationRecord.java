...
public class SupplierEvaluationRecord {
    ...
    public SupplierEvaluationRecord(Integer id, String supplierNum, String qcWay, String year, Integer qualityScore, String qualityPerson, Date qualityDate, Integer deliverScore, String deliverPerson, Date deliverScoreDate, Integer otherScore, String otherPerson, Long otherScoreDate, Date priceScore, String pricePerson, Date priceScoreDate, Integer totalScore, String totalPerson, Date totalScoreDate, String managerOpinions, String managerPerson, Date managerOpinionsDate, String remark, Byte isDelete, Date createData, Date updateDate) {
        this.id = id;
