...
public class PressureInspectUnqualified {
    private Integer id;
    ...
    public PressureInspectUnqualified(Integer id, String inspectNo, String orderNo, String productModel, String productSpecifications, Integer unqualifiedNumber, String reason, String testingPerson, String inspector, Date inspecteTime, Date createTime, Date updateTime, Integer createUserId) {
        this.id = id;
    ...
    public PressureInspectUnqualified() {
        super();
    }
