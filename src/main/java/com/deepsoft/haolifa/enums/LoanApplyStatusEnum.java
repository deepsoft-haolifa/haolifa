...
public enum LoanApplyStatusEnum {
    ...
    private String code;
    private String desc;
    public static LoanApplyStatusEnum valueOfCode(String code) {
        LoanApplyStatusEnum statusEnum = Arrays.stream(LoanApplyStatusEnum.values())
    ...
    LoanApplyStatusEnum(String code, String desc) {
        this.code = code;
        this.desc = desc;
    }
}
